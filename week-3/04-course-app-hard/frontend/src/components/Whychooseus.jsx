    ...
    <div className="py-10 ">
      ...
      <div className="flex justify-center">
        <div className="flex flex-row pt-7 justify-between w-[90%]">
          <CardComponent title=" Progress Tracking and Information" />
          <CardComponent title="Diverse Course Selection" />
          <CardComponent title="Accessibility and Convenience" />
          <CardComponent title="Interactive Learning Experience" />
        </div>
      </div>
    </div>
  );
