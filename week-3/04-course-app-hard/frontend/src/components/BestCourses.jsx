  ...
  return (
    <div className="py-5">
      ...
      <div className="flex justify-center items-center pt-7">
        <input className="px-5 w-1/4 py-3 rounded-lg shadow-md" placeholder="Search for more courses"></input>
        <button className="bg-[#C0E861] text-sm font-semibold px-5 mx-4 py-3 rounded-lg shadow-sm">See More</button>
      </div>
        ...
        {courses.map((key) => {
          return (
            <div className="col-span-1 border bg-white rounded-lg flex flex-col w-[300px] h-[350px]">
              ...
              <p className="paragraph text-[12px] text-gray-500">{key.description}</p>
              <div className="flex pt-5 justify-between items-center">
              <p className="text-[#11906D] font-bold ">Rs. {key.price}</p>
              <button className="bg-[#C0E861] font-semibold px-4 py-1 rounded-md">Enroll</button>
              </div>
              </div>
            </div>
          );
